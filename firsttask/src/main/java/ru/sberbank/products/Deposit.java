 ...
 * баланс, валюту, статус вклада и предлагает методы для ввода средств и закрытия счета.
 *
...
public class Deposit extends AbstractProduct implements IDeposit {
     ...
     * Если вклад уже закрыт, логирует сообщение об ошибке.
     *
    ...
    /**
     * Закрывает вклад, обнуляет баланс и логирует сумму, выплачиваемую клиенту.
     * Если вклад уже закрыт, логирует сообщение об ошибке.
     */
    public void close() {
        if (isOpen) {
